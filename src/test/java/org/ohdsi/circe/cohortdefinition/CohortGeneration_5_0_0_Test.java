...
public class CohortGeneration_5_0_0_Test extends AbstractDatabaseTest {
  ...
  @Test
  public void generateCohortDetailsXTest() throws SQLException {

    final CohortExpressionQueryBuilder.BuildExpressionQueryOptions options = buildExpressionQueryOptions(1,"results");
    options.retainCohortCovariates = true;

    // prepare results schema
    prepareSchema(options.resultSchema, RESULTS_DDL_PATH);

    final String expression = ResourceHelper.GetResourceAsString("/printfriendly/generateCohortDetailsXTest.json");
