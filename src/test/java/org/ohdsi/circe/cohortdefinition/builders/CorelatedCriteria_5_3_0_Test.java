...
public class CorelatedCriteria_5_3_0_Test extends AbstractDatabaseTest {
  ...
  public void visitDetailCodesetCriteriaTest() throws Exception {
    ...
    // translate to PG
    String inGenderQuery = queryBuilder.getCriteriaGroupQuery(cg, eventTable, null, false);
    ...
    // translate to PG
    String notInGenderQuery = queryBuilder.getCriteriaGroupQuery(cg, eventTable, null, false);
    ...
    // translate to PG
    String inProviderQuery = queryBuilder.getCriteriaGroupQuery(cg, eventTable, null, false);
    ...
    // translate to PG
    String notInProviderQuery = queryBuilder.getCriteriaGroupQuery(cg, eventTable, null, false);
    ...
    // translate to PG
    String inPlaceOfServiceQuery = queryBuilder.getCriteriaGroupQuery(cg, eventTable, null, false);
    ...
    // translate to PG
    String notInPlaceOfServiceQuery = queryBuilder.getCriteriaGroupQuery(cg, eventTable, null, false);
