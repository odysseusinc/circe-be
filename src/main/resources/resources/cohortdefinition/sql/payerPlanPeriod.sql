...
select C.person_id, C.payer_plan_period_id as event_id, @startDateExpression as start_date, @endDateExpression as end_date, C.payer_concept_id as TARGET_CONCEPT_ID, NULL as visit_occurrence_id
from
(
