...
select person_id, min(start_date) as start_date, end_date @addColumnQeTempId
into #final_cohort
from ( --cteEnds
	SELECT
	   c.person_id
	...
	GROUP BY c.person_id, c.start_date @addColumnQeTempId
) e
group by  e.person_id, e.end_date @addColumnQeTempId
;
